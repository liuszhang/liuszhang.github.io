...
var g=this,h;
if(g.sId=="project"||g.sId=="school_experience"||g.sId=="experience"||g.sId=="education"||g.sId=="awards")
{
f.sort(function(i,j){
if(!h)
{
...
return parseFloat(j[h])-parseFloat(i[h]);
});
}
...
{
var o=['<div class="resume_mod_addExp" style="padding-top: 30px;padding-bottom: 0px;">','<a id="js_add" class="resume_mod_addExp_cnt" href="javascript:;">','<span class="resume_mod_addExpIco"></span>',,(i.sResumeType=='en'?'Add ':'\u6DFB\u52A0'),i.sName,'</a>','</div>',o].join("");
}
l.setHtml('content',o);
...
a.insertHTML(j.firstChild,'afterEnd',h(k.sId,k.sViewName));
r=a.finds('.module_edit_single',j);
k.initValidata(r[0]);
var o=r.length,t=r[0],s=a.finds('.first_input',t)[0];
a.Top.rmClass(r[1],'resume_mod_exp_Last');
...
var g=this,h=g.name_(),i;
if(h==="resume.model.module_project"||h==="resume.model.module_school_experience"||h==="resume.model.module_experience"||h==="resume.model.module_education"||h==="resume.model.module_awards")
{
f.sort(function(j,k){
if(!i)
{
if(h==="resume.model.module_awards")
{
i="time";
}
else{
...
return parseFloat(k[i])-parseFloat(j[i]);
});
}
},toServJSON:function(){
var f=this.super_(d,'toJSON',arguments);
...
var e=getTop();
var f=$.inWin();
e.loadJsFileToTop(['$js_path$com/kits/qmfileupload/qqmail/js/ftn321adc.js']);
function b(j,i,h)
{
...
var c=b('QMPreviewer',["$js_path$qmplayer/player32be95.js","$js_path$com/kits/qmpreviewer/js/qmpreviewer32c492.js"],60*1000);
...
var a=$.TE(['<div class="resume_collect">','<div class="qui_dragArea" ui-type="resume_works_drag"></div>','<ul class="qui_clear resume_collect_cnt">','<li class="resume_collect_item" ui-type="uploadWorksBtn" style="position: relative;">','<div id="worksUploader" style="overflow:hidden;width:100%;height:100%;">','<div class="resume_collect_item_addWrap">','<a class="resume_collect_item_add" href="javascript:;"></a>','</div>','<div class="resume_collect_item_name resume_collect_item_name_Upload" style="width:50px;">\u4E0A\u4F20\u4F5C\u54C1</div>','<div ui-type="uploadWaring" class="esume_collect_item_name resume_collect_item_name_Upload" style="color: #494949;border:none;display:none">','\uFF08\u672A\u5B89\u88C5\u4E0A\u4F20\u63A7\u4EF6\uFF0C<a style="color: blue;" target="_blank" href="/cgi-bin/readtemplate?t=browser_addon&check=false&returnsid=$@$eval Q.sid()$@$">\u70B9\u51FB\u5B89\u88C5</a>\uFF09','</div>','</div>','</li>','</ul>','</div>']);
...
b.face=a([]);
b.baseinfo=a(['<div class="resumeEn_baseInfo_title">','$@$if($isEmpty$)$@$\u59D3\u540D$@$else$@$$name$$@$endif$@$','</div>','<div class="resumeEn_baseInfo_cnt qui_clear">','$@$if($avatar$ && $visible$)$@$','<div class="resumeEn_baseInfo_cnt_avatarWrap">','<img class="resumeEn_baseInfo_cnt_avatar" src="$avatar$" alt="\u7528\u6237\u5934\u50CF" />','</div>','$@$endif$@$','<div class="resumeEn_baseInfo_cnt_right">','$@$if($isEmpty$ || (!$isEmpty$ && $email$ ) )$@$','<div class="resumeEn_baseInfo_cnt_item">','$@$if($isEmpty$)$@$\u90AE\u7BB1$@$else$@$<a href="$email$">$email$</a>$@$endif$@$','</div>','$@$endif$@$','$@$if($isEmpty$ || (!$isEmpty$ && $mobile$ ) )$@$','<div class="resumeEn_baseInfo_cnt_item">','$@$if($isEmpty$)$@$\u624B\u673A$@$else$@$$mobile$$@$endif$@$','</div>','$@$endif$@$','$@$if($isEmpty$ || (!$isEmpty$ && $city$ ) )$@$','<div class="resumeEn_baseInfo_cnt_item">','$city$','</div>','$@$endif$@$','</div>','</div>']);
...
if(e)
{
var h=f("popup",d.getUploadConfig_(g.qmFileSelecter));
if(!h)
{
d.$$('[ui-type="uploadWaring"]').show();
}
d._moUploader=h;
c(d._moUploader);
}
