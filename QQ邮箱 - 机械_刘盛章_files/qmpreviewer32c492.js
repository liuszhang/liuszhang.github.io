...
if(!g[h])
{
g.loadJsFileToTop(["$js_path$qmplayer/player32be95.js"]);
}
g.waitFor(function(){
return !!g[h];
},function(i){
...
t.sName&&this._moOperator.setTitle&&this._moOperator.setTitle(a.htmlEncode(t.sName));
};
...
f.sName&&this._moViewer._moOperator.setTitle&&this._moViewer._moOperator.setTitle(a.htmlEncode(f.sName));
};
